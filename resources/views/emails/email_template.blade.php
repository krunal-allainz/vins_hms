...
<html>	
  ...
  <title>VIMS Mail</title>	
  </head>	
  <body>	
  	<div class="col text-center">	
	<img src="/assets/img/nabh_vins_logo.png" id="logo-desk" alt="NABH Logo" class="" height="80px">	
</div>	
    <center>	
      <table width="600" background="#FFFFFF" style="text-align:left;" cellpadding="0" cellspacing="0">	
        <tr>	
        	<td height="18" width="31" style="border-bottom:1px solid #e4e4e4;">	
        		<div style="line-height: 0px; font-size: 1px; position: absolute;">	
        			&nbsp;	
        		</div>	
        	</td>	
       ...
       <tr>	
        ...
        <tr>	
        	...
        	<td background="images/greenback.gif" bgcolor="#45a853" style="border-top:1px solid #FFF; border-bottom:1px solid #FFF; padding-left:15px;" height="113">	
        		<span style="color:#FFFFFF; font-size:18px; font-family:Trebuchet MS, Verdana, Arial;">VINS Patient Management System</span>	
        	</td>	
        </tr>	

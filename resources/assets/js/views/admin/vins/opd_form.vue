                ...
                return {
                    ...
                    'investigationData': {
                        ...
                        'radiologyQualifier': [{
                            ...
                            value: 'stroke_protocol'
                        }, {
                            text: 'Epilepsy protocol',
                            value: 'epilepsy_protocol'
                        }, {
                            text: 'Headache protocol',
                            value: 'headache_protocol'
                        }, {
                            text: 'Tumor protocol',
                            value: 'tumor_protocol'
                        }],
                        'X-Rays': '',
                        'xray_type_options': [{
                            text: 'Fixed',
                        ...
                        'CT_options': [{
                            ...
                            text: 'Brain (Plain & Contrast)',
                            value: 'brain_plain_contrast'
                        }, {
                            text: 'Neck',
                            value: 'neck'
                        }, {
                            ...
                            text: 'CT Angiography',
                            value: 'ct_angiography'
                        }, {
                            text: 'Guided Procedure:Biopsy',
                            value: 'guided_procedure'
                        }, ],
                        'MRI': '',
                        'MRI_options': [{
                            text: 'Brain',

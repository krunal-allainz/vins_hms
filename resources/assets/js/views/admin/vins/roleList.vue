                  ...
                  <span data-v-744e717e="">Rows per page:</span>
                   ...
                   <!--     <option data-v-744e717e="" value="-1">All</option> -->
                     ...
                     <div data-v-744e717e="" class="datatable-info  pb-2 mt-6">
                        <ul class="pagination">
                           <li> <a href="javascript:void(0)"  @click="getRolesListWithPaggination('role/getRoleList?page=1',perPage)" class="previous" v-if="pagination.current_page!=1">&laquo; First</a></li>
                         ...
                         <li v-for="record_pagination,index in pagination.last_page" >
                            <span v-if="Math.abs(record_pagination - pagination.current_page)<3">
                                <a v-bind:class="[pagination.current_page==++index ? 'active' : '']" href="javascript:void(0)" @click="getRolesListWithPaggination('role/getRoleList?page='+index,perPage)">{{index}}</a>
                            </span>
                          </li> 
                          <li><a href="javascript:void(0)"  v-if="pagination.current_page!=pagination.last_page" @click="getRolesListWithPaggination(pagination.next_page_url,perPage)" class="next">Next &raquo;</a></li>
                           <li><a href="javascript:void(0)"  v-if="pagination.current_page!=pagination.last_page" @click="getRolesListWithPaggination('role/getRoleList?page='+pagination.last_page,perPage)" class="next">Last &raquo;</a></li>
                        </ul>
                      </div>

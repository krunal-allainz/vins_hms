                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" id="doctor"
                                               placeholder="Doctor Name" v-validate="'required'" v-model="prescriptionData.doctor" name="doctor">
                                        <i v-show="errors.has('doctor')" class="fa fa-warning"></i>
                                        <span class="help is-danger" v-show="errors.has('doctor')">Please enter valid Doctor Name.</span>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col-md-3">

				...
				<table class="table table-bordered table-striped ">
					<tbody>
						...
						<tr>
							...
							<td><input class="form-control" type="text" name="total_beds" v-model="report.total_beds"  v-validate="'required|numeric'" />
						...
						<tr>
							...
							<td><input class="form-control" type="text" name="total_icu_beds" v-model="report.total_icu_beds"  v-validate="'required|numeric'"  />
						...
						<tr>
							...
							<td><input class="form-control" type="text" name="total_ot" v-model="report.total_ot"  v-validate="'required|numeric'" />
			...
			<table class="table table-bordered table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>CQI 3 (c)</td>
						<td><input class="form-control" type="text" name="total_medication_error" v-model="report.total_medication_error" value=""  /></td>
					...
					<tr>
						...
						<td>CQI 3 (c)</td>
						<td><input class="form-control" type="text" name="total_inpatient_medicationerror" v-model="report.total_inpatient_medicationerror" value=""   /></td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td><input class="form-control" type="text" name="units_blood_transfusion_reaction" v-model="report.units_blood_transfusion_reaction" value=""   /></td>
					...
					<tr>
						...
						<td>COP 5(g),CQI (3f)</td>
						<td><input class="form-control" type="text" name="total_units_issued" v-model="report.total_units_issued" value="" /></td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td><input class="form-control" type="text" name="uninary_catheterised" v-model="report.uninary_catheterised" value=""/></td>
					...
					<tr>
						...
						<td>HIC 4(a),CQI 3 (g)</td>
						<td><input class="form-control" type="text" name="uninary_catheter_days" v-model="report.uninary_catheter_days" value=""  /></td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td><input class="form-control" type="text" name="total_episodes_vap" v-model="report.total_episodes_vap" value=""  /></td>
					...
					<tr>
						...
						<td>HIC 4(b),CQI (3g)</td>
						<td><input class="form-control" type="text" name="total_ventilator_days" v-model="report.total_ventilator_days" value=""  /></td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td><input class="form-control" type="text" name="total_crbsi" v-model="report.total_crbsi" value=""   /></td>
					...
					<tr>
						...
						<td>HIC 4(c), CQI 3(g)</td>
						<td><input class="form-control" type="text" name="total_central_line_days" v-model="report.total_central_line_days" value=""  /></td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td><input class="form-control" type="text" name="total_ssi" v-model="report.total_ssi" value=""   /></td>
					...
					<tr>
						...
						<td>HIC 4(d), CQI 3(g)</td>
						<td><input class="form-control" type="text" name="total_surgeries" v-model="report.total_surgeries" value=""   /></td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>CQI4(b)</td>
						<td><input class="form-control" type="text" name="total_fall_patients" v-model="report.total_fall_patients" value=""  /></td>
					...
					<tr>
						...
						<td>CQI4(b)</td>
						<td><input class="form-control" type="text" name="total_inpatient_fall" v-model="report.total_inpatient_fall" value=""    /></td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>CQI 4(b)</td>
						<td><input class="form-control" type="text" name="total_bed_sores" v-model="report.total_bed_sores" value=""    /></td>
					...
					<tr>
						...
						<td>Total number of in patient days</td>
						<td>CQI 4(b)</td>
						<td><input class="form-control" type="text" name="total_inpatient_bedsore" v-model="report.total_inpatient_bedsore" value=""   /></td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>CQI 4(C)</td>
						<td><input class="form-control" type="text" name="total_patient_days_month" v-model="report.total_patient_days_month" value=""   /></td>
					...
					<tr>
						...
						<td>CQI 4(C)</td>
						<td><input class="form-control" type="text" name="available_bed_days" v-model="report.available_bed_days" value=""  /></td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td><input class="form-control" type="text" name="total_inpatient_avgStay" v-model="report.total_inpatient_avgStay" value=""  /></td>
					...
					<tr>
						...
						<td>AAC 14(a),CQI 4 (c) </td>
						<td><input class="form-control" type="text" name="total_spearations" v-model="report.total_spearations" value=""   /></td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td><input class="form-control" type="text" name="reported_needle_injury" v-model="report.reported_needle_injury" value=""   /></td>
					...
					<tr>
						...
						<td>Total in patient days</td>
						<td>CQI 6(a),CQI 4 (f)</td>
						<td><input class="form-control" type="text" name="total_inpatient_needle" v-model="report.total_inpatient_needle" value=""    /></td>
						<td></td>
					</tr>
				</tbody>
			</table>
        ...
        data() {
            return {
                ...
                'report' : {
					...
					'total_beds' : '10',
					'total_icu_beds' : '15',
					'total_non_icu_beds' : '20',
					'avg_doctors' : '11',
					'avg_nurses' : '20',
					'total_ot' : '10',
					'avg_admissions_per_day' : '12',
					'avg_patients_visiting_opd' : '30',
					'avg_patients_visiting_emergency' : '15',
					'avg_surgeries' : '30',
					'avg_emergency_surgeries' : '25',
					'avg_day_care_surgeries' : '25',
					'avg_units_water' : '150',
					'avg_electricity' : '200',		
					...
					'avg_stay' : 0,
					'total_spearations' : '10',
					'reported_needle_injury' : '20',
					'total_needle_injury' : '25',
					'total_inpatient_needle' : '10	',

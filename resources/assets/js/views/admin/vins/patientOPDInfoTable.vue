                                    ...
                                    <tbody>
                                      <tr v-for="(opd_data, index) in opdPatientData">
                                          ...
                                          <td>
                                            ...
                                            <router-link v-if="opd_data.t_status=='examine'" :to="{ path: 'opd_view_page', props: { patientId: opd_data.patient_id }}" :patientId="opd_data.patient_id "><i class="fa fa-eye" @click="SetPatientOpdView(opd_data.patient_id,opd_data.opd_id,opd_data.case_id)" ></i></router-link>

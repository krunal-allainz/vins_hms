<?php
 ...
 class PatientRepository 
 {
   ...
   {
       $result = PatientCaseManagment::select('patient_case_managment.id','patient_case_managment.case_type','patient_case_managment.section_id','patient_case_managment.patient_id','patient_case_managment.references','patient_case_managment.main_case_id','token_managment.token','token_managment.date','token_managment.status')->join('token_managment','token_managment.patient_case_id','=','patient_case_managment.id')->where('patient_case_managment.section_id',$opdId)->orderBy('patient_case_managment.id','DESC')->first();

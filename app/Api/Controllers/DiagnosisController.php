...
use euro_hms\Models\ProvisionalDiagnosis;
use euro_hms\Models\DiagnosisCategoryList;
...
class DiagnosisController extends Controller
{
    ...
    {
    	$diagnosisCatList = DiagnosisCategoryList::all();
    	$provisionaldiagnosisList = ProvisionalDiagnosis::all();
		if ($provisionaldiagnosisList) {
			$data = ['DiagnosisCategoryList'=>$diagnosisCatList,'DiagnosisList'=>$provisionaldiagnosisList];
            return ['code' => '200','data'=>$data, 'message' => 'Data Sucessfully Inserted'];
        }
    }
